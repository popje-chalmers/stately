...
public class GUIViewer extends JPanel implements StatelyListener, MouseListener, MouseMotionListener, MouseWheelListener, KeyListener, FocusListener
{
    ...
    public GUIViewer(StatelyApp app)
    {
        this.app = app;
